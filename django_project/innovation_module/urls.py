...
urlpatterns = [
    ...
    # path('ideasfilteredOdlozony', views.ideasfilteredOdlozony , name='ideasfilteredOdlozony'),
    # path('ideasfilteredZablokowany', views.ideasfilteredZablokowany , name='ideasfilteredZablokowany'),
